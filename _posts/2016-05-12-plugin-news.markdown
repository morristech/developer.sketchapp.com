...
We have posted [some documentation](/reference/action/) and [example Plugins](/examples/plugins/) for action support.
...
Consider this an early warning that it is coming, and again, please [send us feedback](mailto:developers@sketchapp.com) on how you’d like to see it work.
