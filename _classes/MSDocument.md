...
See also [MSContentDrawView](/reference/class/MSContentDrawView/) if you need more precise zooming control.
...
Get / set an [MSPage](/reference/class/MSPage/) object, representing the current page.

### findCurrentArtboardGroup:

Returns an [MSArtboardGroup](/reference/class/MSArtboardGroup/) object, representing the current Artboard.
...
Returns an NSArray representing the artboards and slices on the current page. Artboards are of type [MSArtboardGroup](/reference/class/MSArtboardGroup/) and slices are of [MSSliceLayer](/reference/class/MSSliceLayer/) type.
...
Returns an array of all pages in the document. Each page is an [MSPage](/reference/class/MSPage/) object.

### askForUserInput:(NSString)label initialValue:(NSString)defaultString

Asks for user input and returns the value they chosen. The first argument is the label for the dialog panel, the second argument can be used to provide a default value. See the [User Input & Feedback](/examples/code/user-interaction/) section for examples.
...
Returns an [MSContentDrawView](/reference/class/MSContentDrawView/) subclass that represents the visible Canvas.
...
Returns an [MSEventHandler](/reference/class/MSEventHandler/) object.

### (MSRulerData)currentHorizontalRulerData:

Returns an [MSRulerData](/reference/class/MSRulerData/) object for the horizontal rulers.

### (MSRulerData)currentVerticalRulerData:

Returns an [MSRulerData](/reference/class/MSRulerData/) object for the vertical rulers.

### addBlankPage:

Adds a new [MSPage](/reference/class/MSPage/) object to the document, inserting it below the current page, copying its grid and ruler position too.

### removePage:(MSPage)page

Removes the given page from the document. The argument is an [MSPage](/reference/class/MSPage/) object.
...
Deletes the given `array` of [MSArtboardGroup](/reference/class/MSArtboardGroup/) objects from the page.
